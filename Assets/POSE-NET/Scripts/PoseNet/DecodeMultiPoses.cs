...
public partial class PoseNet {
        ...
        float scoreThreshold, int nmsRadius = 20)
    {
        ...
        public Pose[] DecodeMultiplePosesOG(
        ...
        float scoreThreshold, int nmsRadius = 20)
    {
        ...
        PriorityQueue<float, PartWithScore> queue = BuildPartWithScoreQueueOG(
            scoreThreshold, kLocalMaximumRadius, scores);
        ...
        {            
            ...
            // a previously detected instance.
            var rootImageCoords =
                GetImageCoordsOG(root.part, outputStride, offsets);
